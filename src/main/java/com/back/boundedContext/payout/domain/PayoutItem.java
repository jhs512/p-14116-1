...
public class PayoutItem extends BaseIdAndTime {
    ...
    public PayoutItem(Payout payout, PayoutEventType eventType, String relTypeCode, int relId, LocalDateTime payDate, PayoutMember payer, PayoutMember payee, int amount) {
        this.payout = payout;
