...
public class Payout extends BaseIdAndTime {
    ...
    public PayoutItem addItem(PayoutEventType eventType, String relTypeCode, int relId, LocalDateTime payDate, PayoutMember payer, PayoutMember payee, int amount) {
